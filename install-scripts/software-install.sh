...
YAYNONES="slatec remarkable-client rmapi slack-desktop slack-term spotify-tui-git spotify mfetch-git android-messages-desktop zoom python-numba"
##########################################################################
# yay install
